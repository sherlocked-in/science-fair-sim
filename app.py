...
# ==================================================
# EXECUTIVE METRICS (RESTORED ORIGINAL SIZE)
# ==================================================
...
col5.metric("Detectable Effect Size", "Large*")  # <-- change here

# Footnote in caption for the asterisk
st.caption(
    ...
    "**Power analysis**: Based on 13 trials, only very large differences are reliably detectable; smaller differences may be missed. *'Large*' here reflects that only very pronounced differences can be detected with this small dataset. "
    "References: Cohen (1988); Mann & Whitney (1947)."
)
st.markdown("---")
